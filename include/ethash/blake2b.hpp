...
inline hash512 blake2b512(const uint8_t* data, size_t size) noexcept
{
    return ethash_blake2b512(data, size);
}

inline hash512 blake2b512(const hash512& input) noexcept
{
    return ethash_blake2b512_64(input.bytes);
}
